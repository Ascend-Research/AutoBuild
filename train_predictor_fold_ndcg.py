...
from ge_utils.diff_srcc import LTRLoss
from ge_utils.misc_utils import set_random_seed
from ge_utils.metrics import compute_predictor_test_stats_ltr
...
def train_predictor(params, fold):
    ...
    hop_srcc = compute_predictor_test_stats_ltr(test_tar, test_preds, test_embed_list, predictor)

    for i, srcc in enumerate(hop_srcc):
        predictor.hop_srcc[i] = srcc
...
if __name__ == "__main__":
    ...
    # This predictor uses an 80/20 train/test split and leverages the test NDCG@10 to weight subgraph scores.
    ...
    params.add_argument("-tag", type=str, default="ndcg")
