...
def train_predictor(params, fold):
    ...
    criterion = CorrelLoss(t.nn.MSELoss(), l_lambda=params.corr_lambda, p=params.norm, srcc_list=srcc_list)
...
if __name__ == "__main__":
    ...
    # This predictor uses an 80/20 train/test split and leverages the test SRCC to weight subgraph scores.
    ...
    params.add_argument("-tag", type=str, default="srcc")
